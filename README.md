...
- **Privacy Impact Assessment (PIA)** - provides details regarding PIAs and the assessment templates required by Mercy Corps' Responsible Data policy.
- **File sharing** - presents an overview of best practices using G Suite at Mercy Corps and a brief tutorial.
- **Deidentification** - contains an overview of de-identification - including anonymization and pseudonymization - and an example of one way to deidentify a dataset using spreadsheet software.
